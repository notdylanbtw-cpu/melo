...
export const APP_LOGO: Record<string, string> = {
  twilio: "/logos/twilio.png?v=live",
  gcal: "/logos/googlecalendar.svg?v=real",
  outlook: "/logos/microsoftoutlook.svg?v=real",
  servicem8: "/logos/servicem8.png?v=live",
  jobber: "/logos/jobber.svg?v=badge",
  fergus: "/logos/fergus.png?v=live",
  simpro: "/logos/simpro.png?v=live",
  ...
  pipedrive: "/logos/pipedrive.png?v=live",
  ...
  messenger: "/logos/messenger.png?v=live",
